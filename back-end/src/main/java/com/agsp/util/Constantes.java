...
public class Constantes {
	...
	public static final String CPF_CDASTRADO = "Ja existe um usuário cadastrado com CPF informado.";

	public static final String SENHAS_DIFERENTES = "Senhas diferentes. Digite a mesma senha em ambos os campos de senha";
